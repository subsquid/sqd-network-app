export const portalPoolAbi = [
  ...
  { type: 'error', name: 'NotPoolRegistry', inputs: [] },
  ...
  { type: 'error', name: 'CapacityOutOfRange', inputs: [] },
