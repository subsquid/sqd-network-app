...
function parseBucketSize(bucket) {
...
function getGroupSize(step) {
    if (typeof step === 'string') {
        return parseBucketSize(step);
    }
    const { from, to, maxPoints = 50 } = step;
    const rangeMs = Math.max(0, (0, date_fns_1.differenceInMilliseconds)(to, from));
...
//# sourceMappingURL=groupSize.js.map