...
export const SquidNetworkHeightDocument = new TypedDocumentString(`
  ...
  squidStatus {
    ...
    `) as unknown as TypedDocumentString<SquidNetworkHeightQuery, SquidNetworkHeightQueryVariables>;
...
export const VestingsByAccountDocument = new TypedDocumentString(`
  ...
  type
  balance
}`) as unknown as TypedDocumentString<VestingsByAccountQuery, VestingsByAccountQueryVariables>;
...
fragment WorkerBaseFragment on Worker {
  ...
  name
  peerId
}`) as unknown as TypedDocumentString<SourcesWithAssetsQuery, SourcesWithAssetsQueryVariables>;
...
}`) as unknown as TypedDocumentString<VestingByAddressQuery, VestingByAddressQueryVariables>;
...
fragment WorkerFragment on Worker {
  ...
  ...WorkerStatsFragment
  ...WorkerOwnershipFragment
}`) as unknown as TypedDocumentString<AllWorkersQuery, AllWorkersQueryVariables>;
...
}`) as unknown as TypedDocumentString<WorkerByPeerIdQuery, WorkerByPeerIdQueryVariables>;
...
export const MyWorkersCountDocument = new TypedDocumentString(`
  ...
  workersConnection(
    ...
    `) as unknown as TypedDocumentString<MyWorkersCountQuery, MyWorkersCountQueryVariables>;
...
}`) as unknown as TypedDocumentString<WorkerOwnerQuery, WorkerOwnerQueryVariables>;
export const MyDelegationsDocument = new TypedDocumentString(`
    query myDelegations($address: String!, $peerId: String) {
  workers(
    orderBy: id_ASC
    where: {peerId_eq: $peerId, delegations_some: {OR: [{owner: {id_eq: $address}, deposit_gt: 0}, {owner: {owner: {id_eq: $address}}, deposit_gt: 0}, {owner: {temporaryHolding: {beneficiary: {id_eq: $address}}}, deposit_gt: 0}]}}
  ) {
    ...WorkerFragment
    delegations(
...
fragment WorkerFragment on Worker {
  ...
  ...WorkerStatsFragment
  ...WorkerOwnershipFragment
}`) as unknown as TypedDocumentString<MyDelegationsQuery, MyDelegationsQueryVariables>;
...
}`) as unknown as TypedDocumentString<GatewayByPeerIdQuery, GatewayByPeerIdQueryVariables>;
...
}`) as unknown as TypedDocumentString<MyGatewaysQuery, MyGatewaysQueryVariables>;
...
fragment GatewayStakeFragment on GatewayStake {
  ...
  lockStart
  lockEnd
}`) as unknown as TypedDocumentString<MyGatewayStakesQuery, MyGatewayStakesQueryVariables>;
export const NetworkSummaryDocument = new TypedDocumentString(`
  ...
  networkStats {
    ...
    `) as unknown as TypedDocumentString<NetworkSummaryQuery, NetworkSummaryQueryVariables>;
export const CurrentEpochDocument = new TypedDocumentString(`
  ...
  epoches(limit: 1, orderBy: id_DESC) {
    ...
    `) as unknown as TypedDocumentString<CurrentEpochQuery, CurrentEpochQueryVariables>;
...
export const RewardTimeseriesDocument = new TypedDocumentString(`
  ...
  rewardTimeseries(from: $from, to: $to, step: $step, workerId: $workerId) {
    ...
    `) as unknown as TypedDocumentString<RewardTimeseriesQuery, RewardTimeseriesQueryVariables>;
export const AprTimeseriesDocument = new TypedDocumentString(`
  ...
  aprTimeseries(from: $from, to: $to, step: $step, workerId: $workerId) {
    ...
    `) as unknown as TypedDocumentString<AprTimeseriesQuery, AprTimeseriesQueryVariables>;
export const UptimeTimeseriesDocument = new TypedDocumentString(`
  ...
  uptimeTimeseries(from: $from, to: $to, step: $step, workerId: $workerId) {
    ...
    `) as unknown as TypedDocumentString<UptimeTimeseriesQuery, UptimeTimeseriesQueryVariables>;
