...
export type WorkerByPeerIdQueryVariables = Exact<{
  ...
  ownerIds?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
}>;
...
export const WorkersByOwnerDocument = new TypedDocumentString(`
  ...
  workers(
    ...
    `) as unknown as TypedDocumentString<WorkersByOwnerQuery, WorkersByOwnerQueryVariables>;
export const DelegationsByOwnerDocument = new TypedDocumentString(`
  ...
  delegations(
    ...
    `) as unknown as TypedDocumentString<DelegationsByOwnerQuery, DelegationsByOwnerQueryVariables>;
export const WorkersSummaryDocument = new TypedDocumentString(`
  ...
  workersSummary {
    ...
    `) as unknown as TypedDocumentString<WorkersSummaryQuery, WorkersSummaryQueryVariables>;
