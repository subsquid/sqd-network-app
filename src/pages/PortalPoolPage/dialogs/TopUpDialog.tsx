  ...
  return (
    <Stack spacing={2.5}>
      <Typography variant="body2" color="text.secondary">
        Add {rewardToken?.symbol ?? "USDC"} rewards to the pool. These funds
        will be distributed to delegators based on their pool share.
      </Typography>
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const rewardAmount = BigInt(
          Math.floor(parseFloat(values.amount) * 10 ** decimals),
        );
