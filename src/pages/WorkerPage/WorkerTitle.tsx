  ...
  return (
    <Stack spacing={0.5}>
      <Stack direction="row" alignItems="center" spacing={0.5}>
        ...
        {canEdit ? (
          <WorkerEdit worker={worker} owner={owner} disabled={!canEdit} />
        ) : null}
      </Stack>
      <Tooltip title="Peer ID - unique identifier for this worker on the network">
        <Typography
          variant="body2"
          component="span"
        ...
        >
          <CopyToClipboard
            text={worker.peerId}
            content={<span>{worker.peerId}</span>}
          />
        </Typography>
      </Tooltip>
    </Stack>
