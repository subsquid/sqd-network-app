...
const CHART_CONFIGS: Record<string, AnalyticsChartProps<any, any>> = {
  lockedValue: {
    ...createSimpleChart({
      ...
      primaryColor: '#4A90E2',
      queryHook: vars => useQuery(trpc.timeseries.lockedValue.queryOptions(vars)),
  ...
  activeWorkers: {
    ...createSimpleChart({
      ...
      primaryColor: '#10B981',
      queryHook: vars => useQuery(trpc.timeseries.activeWorkers.queryOptions(vars)),
      dataPath: (data: any) => data,
  ...
  reward: {
    ...createStackedChart({
      ...
      primaryColor: '#10B981',
      queryHook: vars => useQuery(trpc.timeseries.reward.queryOptions(vars)),
      dataPath: (data: any) => data,
      stacks: [
        {
          key: 'Worker Reward',
  ...
  apr: {
    ...createMultiSeriesChart({
      ...
      primaryColor: '#6B7280',
      queryHook: vars => useQuery(trpc.timeseries.apr.queryOptions(vars)),
      dataPath: (data: any) => data,
      series: [
  ...
  uniqueOperators: {
    ...createSimpleChart({
      ...
      primaryColor: '#8B5CF6',
      queryHook: vars => useQuery(trpc.timeseries.uniqueOperators.queryOptions(vars)),
      dataPath: (data: any) => data,
      tooltipFormat: { y: CHART_FORMATTERS.number.tooltip },
      axisFormat: { y: CHART_FORMATTERS.number.axis },
      strokeWidth: 2,
  ...
  delegations: {
    ...createSimpleChart({
      ...
      primaryColor: '#F59E0B',
      queryHook: vars => useQuery(trpc.timeseries.delegations.queryOptions(vars)),
      dataPath: (data: any) => data,
      tooltipFormat: { y: CHART_FORMATTERS.number.tooltip },
      axisFormat: { y: CHART_FORMATTERS.number.axis },
      strokeWidth: 2,
  ...
  uniqueDelegators: {
    ...createSimpleChart({
      ...
      primaryColor: '#06B6D4',
      queryHook: vars => useQuery(trpc.timeseries.delegators.queryOptions(vars)),
      dataPath: (data: any) => data,
      tooltipFormat: { y: CHART_FORMATTERS.number.tooltip },
      axisFormat: { y: CHART_FORMATTERS.number.axis },
      strokeWidth: 2,
  ...
  transfers: {
    ...createStackedChart({
      ...
      primaryColor: '#6B7280',
      queryHook: vars => useQuery(trpc.timeseries.transfersByType.queryOptions(vars)),
      dataPath: (data: any) => data,
      stacks: [
  ...
  uniqueAccounts: {
    ...createSimpleChart({
      ...
      primaryColor: '#06B6D4',
      queryHook: vars => useQuery(trpc.timeseries.uniqueAccounts.queryOptions(vars)),
      dataPath: (data: any) => data,
  ...
  queries: {
    ...createSimpleChart({
      ...
      primaryColor: '#8B5CF6',
      queryHook: vars => useQuery(trpc.timeseries.queriesCount.queryOptions(vars)),
      dataPath: (data: any) => data,
      seriesName: 'Queries',
      type: 'line',
      tooltipFormat: { y: CHART_FORMATTERS.number.tooltip },
  ...
  servedData: {
    ...createSimpleChart({
      ...
      primaryColor: '#F59E0B',
      queryHook: vars => useQuery(trpc.timeseries.servedData.queryOptions(vars)),
      dataPath: (data: any) => data,
      type: 'line',
  ...
  storedData: {
    ...createSimpleChart({
      ...
      primaryColor: '#4A90E2',
      queryHook: vars => useQuery(trpc.timeseries.storedData.queryOptions(vars)),
      dataPath: (data: any) => data,
      tooltipFormat: { y: CHART_FORMATTERS.bytes.tooltip },
      axisFormat: { y: CHART_FORMATTERS.bytes.axis },
      strokeWidth: 2,
